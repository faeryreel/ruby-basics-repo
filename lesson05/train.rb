class Train
  ...
  def move_forward
    if is_terminal?
      ...
      move_forward!
      puts "\nTrain #{@number} is successfully moved forward."
    end
  end
  ...
  def move_backwards
    if is_initial?
      ...
      move_backwards!
      puts "\nTrain #{@number} is successfully moved backwards."
    end
  end
...
=end 
  ...
  def add_car!(car)
    self.cars << car
    puts "\nCar #{car.number} is successfully added to the train."
  end
...
=end
  ...
  def delete_car!(car)
    ...
    puts "\nCar #{car.number} is successfully deleted from the train."
  end
